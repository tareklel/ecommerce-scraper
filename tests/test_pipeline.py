...
@pytest.fixture
def post_closure_pipeline_test_setup(tmp_path):
    """Fixture to set up a spider and a pipeline for post closure tests."""
    ...
    # Gzip the output to have a final artifact
    spider._gzip_output()

    # Initialize pipeline and run spider_closed
...
class TestManifestPipeline:
    ...
    def test_manifest_structure_and_metadata(self, post_closure_pipeline_test_setup):
        """Tests the basic structure and metadata of the manifest."""
        manifest_data = post_closure_pipeline_test_setup['manifest_data']
        spider = post_closure_pipeline_test_setup['spider']
        start_time = post_closure_pipeline_test_setup['start_time']
        finish_time = post_closure_pipeline_test_setup['finish_time']
        entry_urls = post_closure_pipeline_test_setup['entry_urls']
    ...
    def test_manifest_stats_section(self, post_closure_pipeline_test_setup):
    ...
    def test_manifest_artifacts_section(self, post_closure_pipeline_test_setup):
        """Tests the 'artifacts' section of the manifest."""
        manifest_data = post_closure_pipeline_test_setup['manifest_data']
        tmp_path = post_closure_pipeline_test_setup['tmp_path']
    ...
    def test_manifest_bronze_verification(self, post_closure_pipeline_test_setup):
